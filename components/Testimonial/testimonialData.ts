...
export const testimonialData: Testimonial[] = [
  {
    ...
    image: image1,
    content:
      "CVBoost was an instant improvment for my resume. Their clear feedback led to quick improvements. Really grateful for their help!",
  },
  {
    id: 2,
    name: "Nir Cohen",
    ...
    image: image2,
    content:
      "CVBoost has helped me take my CV to the next level, resulting in more interviews than I could handle!",
  },
  {
    id: 3,
    name: "Dan Oren",
