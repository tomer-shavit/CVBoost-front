...
const CTA = () => {
  return (
    <>
      {/* <!-- ===== CTA Start ===== --> */}
      <section className="overflow-hidden px-4 py-12 md:px-8 lg:py-14 xl:py-16 2xl:px-0">
          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Ready for a Job Offer?
              </h2>
              <p>
                Upload your CV now for AI-powered optimization and stand out to
                employers
              </p>
            </motion.div>
            <motion.div
